...
<div className="flex items-center gap-1 mt-0.5">
    <span
    className={`w-1.5 h-1.5 rounded-full shrink-0 ${BLIND_DOT[champ.blindPick]}`}
    />
...
function MatchupRow({
    ...
    <div className="flex items-start gap-2.5">
        <div
        className={`relative w-8 h-8 rounded-lg overflow-hidden shrink-0 border ${borderColor}`}
        >
        <Image

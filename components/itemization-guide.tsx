...
const ITEMS: ItemEntry[] = [
    {
        ...
        who: ["Karma", "Seraphine", "Sona", "Janna", "Lulu"],
    ...
    },
    {
        ...
        who: ["Sona", "Soraka", "Seraphine", "Milio", "Janna", "Lulu"],
        priority: "core",
    },
    {
        id: 3504,
        ...
        who: ["Milio", "Nami", "Sona", "Lulu", "Janna"],
        priority: "situational",
    },
    {
        id: 3853,
        ...
        who: ["Karma", "Seraphine", "Soraka", "Janna", "Lulu"],
        priority: "niche",
    },
    {
        id: 3011,
    ...
    },
    {
        ...
        who: ["Karma", "Seraphine", "Janna", "Lulu"],
        priority: "situational",
    },
    {
        id: 3601,
        ...
        why: "Active gives your team 40% movement speed for 4 seconds. Amazing for both chasing and running away. On Janna it stacks with her passive MS. On Karma it doubles as a disengage + engage tool.",
        who: ["Karma", "Sona", "Seraphine", "Janna"],
        priority: "situational",
    },
    {
        id: 3114,
        ...
        who: ["Milio", "Sona", "Soraka", "Nami", "Karma", "Seraphine", "Janna", "Lulu"],
        priority: "core",
    },
    {
        id: 3869,
        ...
        when: [
            ...
            "Playing Sona, Soraka, or Janna (E shield triggers it perfectly)",
        ],
        why: "Slows enemies that hit shielded allies. Makes dives extremely painful — they dash onto your ADC, get slowed, and die to your team's follow-up. Janna's E shield is one of the best triggers for this.",
        who: ["Sona", "Soraka", "Milio", "Janna", "Lulu"],
        priority: "niche",
    },
];
                    ...
                    {ITEMS.map((item) => (
                        ...
                        >
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-1.5 flex-wrap">
                                        ...
                                        <span className={`text-xs font-medium px-1.5 py-0.5 rounded-full ${PRIORITY_STYLES[item.priority]}`}>
                                            {item.priority}
                                        </span>
                                    </div>
                                    <div className={`inline-flex items-center gap-1 mt-0.5 text-xs font-semibold px-2 py-0.5 rounded-full border ${TRIGGER_STYLES[item.triggerType]}`}>
                            ...
                            <div className="space-y-1">
                                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Buy when</p>
                            ...
                            {/* best on */}
                            <div className="flex items-center gap-1.5 flex-wrap">
                                <span className="text-xs text-gray-400 font-medium">Best on:</span>
                                {item.who.map((name) => (
                                    <div key={name} className="relative w-5 h-5 rounded-md overflow-hidden border border-pink-100">
                                        <Image

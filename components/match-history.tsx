...
export function MatchHistory({ matches, puuid, queueType }: Props) {
      ...
      <CardContent>
        <div className="space-y-2.5">
          {matches.map((match) => {
            ...
            const winBar = me.win ? "bg-emerald-400" : "bg-rose-400";
            ...
            return (
              ...
              >
                ...
                <div className="relative w-11 h-11 rounded-xl overflow-hidden border-2 border-white shadow-sm shrink-0 ml-1">
                  <Image
                    src={getChampionImageUrl(me.championName)}
                    alt={me.championName}
                    fill
                    className="object-cover"
                    unoptimized
                ...
                <div className="flex flex-col gap-0.5 min-w-0 shrink-0 w-24">
                  ...
                  <span
                    className={`text-xs font-bold ${
                      me.win ? "text-emerald-600" : "text-rose-500"
                    }`}
                  >
                ...
                <div className="flex flex-col items-center gap-0.5 shrink-0 w-20">
                  ...
                  <p className="text-xs text-gray-500 font-medium">{kda} KDA</p>
                  <p className="text-xs text-gray-400">
                    {cs} CS · {csPerMin}/m
                  </p>
                  <p className="text-xs text-gray-400">
                ...
                <div className="hidden sm:flex items-center gap-1 flex-wrap max-w-50">
                  <div className="flex gap-0.5 mb-0.5">
                    <div className="relative w-5 h-5 rounded overflow-hidden border border-white">
                      <Image
                        src={getSpellImageUrl(me.summoner1Id)}
                        alt="spell1"
                        fill
                        unoptimized
                      />
                    ...
                    <div className="relative w-5 h-5 rounded overflow-hidden border border-white">
                      <Image
                        src={getSpellImageUrl(me.summoner2Id)}
                        alt="spell2"
                        fill
                        unoptimized
                      />
